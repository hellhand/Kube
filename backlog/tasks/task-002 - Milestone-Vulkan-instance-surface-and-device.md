---
id: TASK-002
title: 'Milestone: Vulkan instance, surface, and device'
status: Done
assignee: []
...
## Acceptance Criteria
<!-- AC:BEGIN -->
- [x] #1 All child tasks for this milestone are completed and the app can start with a created instance, surface, and logical device.
<!-- AC:END -->
